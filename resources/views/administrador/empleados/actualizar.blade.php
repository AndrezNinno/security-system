                                    ...
                                    <div class="card-block">
                                        <div class="view-info">
                                            <div class="general-info">
                                                <form action="{{ '/administrador/empleados/actualizar/'.$empleado->id }}" method="POST">
                                                    @csrf
                                                    <div class="row">
                                                                ...
                                                                <table class="table m-0">
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <div class="col-lg-9 mt-12 stretched_card">
                                                                                    <select required class="form-control" name="tipoDocumento" value="{{ $empleado->tipo_documento }}">
