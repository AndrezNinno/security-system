...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="/guardia/login" method="POST">
                @csrf
                <div class="login-form-body text-center p-4">
                    <img src="{{ url('assets/images/logo-login.png')}}" class="mb-5" alt="Logo">
                    <div class="row">
                        <div class="col">
                            <select required class="form-gp" name="tipoDocumento">
