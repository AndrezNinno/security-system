    ...
    *===========================-->
    <div class="vz_main_sec">
                ...
                <div class="navbar-content scroll-div">
                    ...
                    <div class="vz_navigation">
                        <ul class="sidebar nav flex-column">
                            <li class="" id="inicio">
                                <a class="nav-link text-center" data-nav="dashboard" href="/guardia/dashboard">
                                    <i class="feather ft-home"></i><span>Inicio</span></a>
                            </li>

                            <li class="" id="visitantes_tour">
                                <a class="nav-link text-center" href="/guardia/visitantes" data-nav="ui_features">
            ...
            <div class="container-fluid d-flex flex-row h-100 align-items-center">
                ...
                *===========================-->
                <div class="text-center rt_nav_wrapper d-flex align-items-center">
                    <a class="nav_logo rt_logo" href="index.html"><img src="{{ url('assets/images/logo-dark.png')}}" alt="logo" /></a>
                    <a class="nav_logo nav_logo_mob" href="index.html"><img src="{{ url('assets/images/mobile-logo.png')}}" alt="logo" /></a>
                </div>
                <!--=========================*
                   End Logo
                *===========================-->
                <div class="nav_wrapper_main d-flex align-items-center justify-content-between flex-grow-1">
                    <ul class="navbar-nav navbar-nav-right mr-0 ml-auto">
                        ...
                        *====================================-->
                        <li class="nav-item nav-profile dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown"style="padding: 10px 30px;" aria-expanded="false">
                                <span class="profile_sec">

                                    <span class="profile_name">
                                        <span class="hi_name">Hola, </span>
                                        {{ $guardia->nombres }} <i class="feather ft-chevron-down"></i>
                                    </span>
                            ...
                            <div class="dropdown-menu dropdown-menu-right navbar-dropdown pt-2"
                                ...
                                <a class="dropdown-item" href="/guardia/perfil">
                                    <i class="ti-user text-dark mr-3"></i> Datos personales
                                </a>

                                <a class="dropdown-item" href="/guardia/logout">
                    ...
                    *===========================-->
                    <span class="d-lg-none">
                        <a class="vz_mobile_menu_icon ml-3" id="vz_mobileCollapseIconMobile"
        ...
        *===========================-->
        ...
        <!-- Hopscotch init Js -->
        <script src="{{ url('assets/js/init/hop-scotch-2.js')}}"></script>
